<?php
return array(
	'tableName' => 'php37_member_level',    // 表名
	...
	'validate' => "
		array('level_name', 'require', '级别不能为空！', 1, 'regex', 3),
		array('level_name', '1,30', '级别的值最长不能超过 30 个字符！', 1, 'length', 3),
		array('level_rate', 'number', '折扣率，100：10折 90：9折..必须是一个整数！', 2, 'regex', 3),
