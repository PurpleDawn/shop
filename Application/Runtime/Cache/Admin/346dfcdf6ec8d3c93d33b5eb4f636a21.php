        ...
        <form action="<?php echo U('add'); ?>" method="post" enctype="multipart/form-data" >
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="market_price" value=""size="30" />
                        <span class="require-field">*</span></td>
                </tr>
                <tr>
                    <td class="label">本店价格：</td>
                    <td><input type="text" name="shop_price" value=""size="30" />
                        <span class="require-field">*</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" checked="checked" name="is_new" value="是" /> 新品
                        <input type="checkbox" checked="checked" name="is_hot" value="是" /> 热销
                        <input type="checkbox" checked="checked" name="is_best" value="是" /> 精品
                    </td>
                </tr>
                <tr>
